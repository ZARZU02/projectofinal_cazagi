...
class EjercioController extends AbstractController
{
    private $em;
    ...
    #[Route('/ejercicios', name: 'app_ejercicio')]
    public function indexcomunidad(): Response
    {
        $clienteRepository = $this->em->getRepository(Ejercicios::class);
        return $this->render('ejercios.html.twig', [
