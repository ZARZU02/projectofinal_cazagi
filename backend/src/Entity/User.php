...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?Dietas $dietas = null;

    #[ORM\ManyToOne(inversedBy: 'users')]
    private ?Consejos $consejos = null;
    ...
    public function getDietas(): ?Dietas
    {
        return $this->dietas;
    }

    public function setDietas(?Dietas $dietas): static
    {
        $this->dietas = $dietas;
    ...
    public function getConsejos(): ?Consejos
    {
        return $this->consejos;
    }

    public function setConsejos(?Consejos $consejos): static
    {
